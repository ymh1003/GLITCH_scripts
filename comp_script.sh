...
output=$(stlinfo "/Users/yumenghe/Desktop/stl_files/$1")
height=$(echo $output | awk -F'Z: ' '{print $2}' | awk '{print $1}')
center=$(echo "$height" | awk '{printf "%.1f", $1 / 2}')

pj3d test1 create "Voron 0" /Users/yumenghe/Library/print_settings.txt
pj3d test1 add "/Users/yumenghe/Desktop/stl_files/$1"
pj3d test1 pack
pj3d test1 print

pj3d test2 create "Voron 0" /Users/yumenghe/Library/print_settings.txt
pj3d test2 add "/Users/yumenghe/Desktop/stl_files/$1"
pj3d test2 pack
...
scp yhe54@capella:Gcode-Checking-Project/heatmap.pcd /Users/yumenghe/
# scp yhe54@capella:Gcode-Checking-Project/visualization_two_pcds.pcd /Users/yumenghe/
conda activate gc
cd read_pcd
python main.py /Users/yumenghe/heatmap.pcd