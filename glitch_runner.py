...
class SlicerPj3d:
    ...
    def generate_gcode2(self, model, storage):
        ...
        for r, f in zip(model.rotation, model.rotated_stl):
            ...
            self.run_pj3d(p, "printpart", f, #"--rotxyz" is removed since model is already rotated
...
class Model:
    ...
    def run_glitch2(self,
        ...
        for i, r in enumerate(self.rotation):
            ...
            #TODO: this will *not* handle scaling done by do_scale
            orig_dimensions = self.dimensions
            logger.warning(f"None of the rotated models are 0,0,0, using original dimensions")
